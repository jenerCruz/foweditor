...
var ErrorBar = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(ErrorBar, [{
    ...
    value: function render() {
      ...
      var svgProps = ReactUtils.filterProps(others, false);
      !!(this.props.direction === 'x' && xAxis.type !== 'number') ? process.env.NODE_ENV !== "production" ? tinyInvariant(false, 'ErrorBar requires Axis type property to be "number".') : tinyInvariant(false) : void 0;
