...
var isPlainObject = require('../../../../../../external/lodash/isPlainObject.js');
var isBoolean = require('../../../../../../external/lodash/isBoolean.js');
var isEqual = require('../../../../../../external/lodash/isEqual.js');
var Rectangle = require('../shape/Rectangle.js');
var Trapezoid = require('../shape/Trapezoid.js');
var Sector = require('../shape/Sector.js');
var Layer = require('../container/Layer.js');
var Symbols = require('../shape/Symbols.js');
...
function ShapeSelector(_ref) {
  ...
  switch (shapeType) {
    case 'rectangle':
      return /*#__PURE__*/React.createElement(Rectangle.Rectangle, elementProps);
    case 'trapezoid':
      return /*#__PURE__*/React.createElement(Trapezoid.Trapezoid, elementProps);
    case 'sector':
      return /*#__PURE__*/React.createElement(Sector.Sector, elementProps);
    case 'symbols':
      if (isSymbolsProps(shapeType)) {
        return /*#__PURE__*/React.createElement(Symbols.Symbols, elementProps);
      }
      break;
    default:
      return null;
...
function Shape(_ref2) {
  ...
  var shape;
  if ( /*#__PURE__*/React.isValidElement(option)) {
    shape = /*#__PURE__*/React.cloneElement(option, _objectSpread(_objectSpread({}, props), getPropsFromShapeOption(option)));
