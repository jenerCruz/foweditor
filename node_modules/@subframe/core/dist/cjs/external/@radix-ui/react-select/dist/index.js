...
var index = require('../external/@radix-ui/react-collection/dist/index.js');
var index$3 = require('../../react-compose-refs/dist/index.js');
var index$1 = require('../../react-context/dist/index.js');
var index$f = require('../external/@radix-ui/react-direction/dist/index.js');
...
var index$b = require('../external/@radix-ui/react-id/dist/index.js');
var index$2 = require('../../react-popper/dist/index.js');
var index$h = require('../../react-portal/dist/index.js');
var index$4 = require('../../react-primitive/dist/index.js');
var index$i = require('../../react-slot/dist/index.js');
var index$e = require('../../react-use-callback-ref/dist/index.js');
var index$g = require('../external/@radix-ui/react-use-controllable-state/dist/index.js');
var index$6 = require('../external/@radix-ui/react-use-layout-effect/dist/index.js');
var index$c = require('../external/@radix-ui/react-use-previous/dist/index.js');
var index$d = require('../../react-visually-hidden/dist/index.js');
...
var Select = (props) => {
  ...
  const direction = index$f.useDirection(dir);
  const [open, setOpen] = index$g.useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
    caller: SELECT_NAME
  });
  const [value, setValue] = index$g.useControllableState({
    prop: valueProp,
...
var SelectPortal = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(index$h.Portal, { asChild: true, ...props });
};
...
var Slot = index$i.createSlot("SelectContent.RemoveScroll");
...
var SelectBubbleInput = React__namespace.forwardRef(
  ({ __scopeSelect, value, ...props }, forwardedRef) => {
    ...
    const prevValue = index$c.usePrevious(value);
    React__namespace.useEffect(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      index$4.Primitive.select,
      {
        ...props,
        style: { ...index$d.VISUALLY_HIDDEN_STYLES, ...props.style },
        ref: composedRefs,
        defaultValue: value
      }
    );
...
function useTypeaheadSearch(onSearchChange) {
  const handleSearchChange = index$e.useCallbackRef(onSearchChange);
