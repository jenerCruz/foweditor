...
import { isInRectangle } from '../shape/Rectangle.js';
import { isChildrenEqual, findChildByType, validateWidthHeight, findAllByType, getDisplayName, filterProps, renderByOrder, parseChildIndex, getReactEventByType } from '../util/ReactUtils.js';
import { Brush } from '../cartesian/Brush.js';
import { getOffset } from '../util/DOMUtils.js';
import { getAnyElementOfObject, findEntryInArray, isNumber, uniqueId, hasDuplicate } from '../util/DataUtils.js';
import { calculateActiveTickIndex, getStackGroupsByAxisId, getTooltipItem, getTicksOfAxis, getBandSizeOfAxis, appendOffsetOfLegend, getStackedDataOfItem, getBarSizeList, getBarPosition, combineEventHandlers, getMainColorOfGraphicItem, parseSpecifiedDomain, getDomainOfDataByKey, parseDomainOfCategoryAxis, parseErrorBarsOfAxis, getDomainOfStackGroups, getDomainOfItemsWithSameAxis, isCategoricalAxis } from '../util/ChartUtils.js';
import { detectReferenceElementsDomain } from '../util/DetectReferenceElementsDomain.js';
import { inRangeOfSector, polarToCartesian } from '../util/PolarUtils.js';
import { shallowEqual } from '../util/ShallowEqual.js';
import { eventCenter, SYNC_EVENT } from '../util/Events.js';
import { adaptEventHandlers } from '../util/types.js';
import { AccessibilityManager } from './AccessibilityManager.js';
import { isDomainSpecifiedByUser } from '../util/isDomainSpecifiedByUser.js';
import { isFunnel, isPie, isScatter, getActiveShapeIndexForTooltip } from '../util/ActiveShapeUtils.js';
import { Cursor } from '../component/Cursor.js';
import { ChartLayoutContextProvider } from '../context/chartLayoutContext.js';
import { getLegendProps } from '../util/getLegendProps.js';
...
export { createDefaultState, generateCategoricalChart, getAxisMapByAxes };
