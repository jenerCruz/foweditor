...
import last from '../../../../../../external/lodash/last.js';
...
function LabelList(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Layer, {
    ...
    return /*#__PURE__*/React__default.createElement(Label, _extends({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (isObject(label)) {
    return /*#__PURE__*/React__default.createElement(LabelList, _extends({
      data: data
    }, label, {
      key: "labelList-implicit"
    }));
