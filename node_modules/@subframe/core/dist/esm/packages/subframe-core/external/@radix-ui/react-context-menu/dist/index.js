...
import { createMenuScope, Root as Root3, Anchor as Anchor2, Portal, Content as Content2$1, Group, Label, Item as Item2$1, CheckboxItem, RadioGroup, RadioItem, ItemIndicator, Separator, Arrow as Arrow2$1, Sub, SubTrigger, SubContent } from '../external/@radix-ui/react-menu/dist/index.js';
...
var ContextMenuSubTrigger = React.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return /* @__PURE__ */ jsx(SubTrigger, { ...menuScope, ...triggerItemProps, ref: forwardedRef });
});
