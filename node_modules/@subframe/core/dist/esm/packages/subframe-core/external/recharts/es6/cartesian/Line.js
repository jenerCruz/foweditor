...
import { interpolateNumber, uniqueId } from '../util/DataUtils.js';
import { findAllByType, filterProps, hasClipDot } from '../util/ReactUtils.js';
...
var Line = /*#__PURE__*/function (_PureComponent) {
  ...
  return _createClass(Line, [{
    ...
    value: function renderCurveStatically(points, needClip, clipPathId, props) {
      ...
      return /*#__PURE__*/React__default.createElement(Curve, _extends({}, curveProps, {
    ...
    value: function renderDotItem(option, props) {
      ...
      if ( /*#__PURE__*/React__default.isValidElement(option)) {
        ...
        dotItem = /*#__PURE__*/React__default.createElement(Dot, _extends({
          key: key
        }, dotProps, {
          className: className
        }));
