import React__default, { Children, PureComponent } from 'react';
...
import { generatePrefixStyle } from '../util/CssPrefixUtils.js';
import { filterProps } from '../util/ReactUtils.js';
import { point } from '../../../../../../external/d3-scale/src/band.js';
  ...
  return _createClass(Brush, [{
    ...
    value: function renderText() {
      ...
      return /*#__PURE__*/React__default.createElement(Layer, {
        ...
        y: y + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /*#__PURE__*/React__default.createElement(Text, _extends({
        textAnchor: "start",
        verticalAnchor: "middle",
