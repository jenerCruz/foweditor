...
import { filterProps, findAllByType } from '../util/ReactUtils.js';
import { Global } from '../util/Global.js';
import { polarToCartesian, getMaxRadius } from '../util/PolarUtils.js';
import { interpolateNumber, isNumber, getPercentValue, mathSign, uniqueId } from '../util/DataUtils.js';
import { getValueByDataKey } from '../util/ChartUtils.js';
import { warn } from '../util/LogUtils.js';
import { adaptEventsOfChild } from '../util/types.js';
import { Shape } from '../util/ActiveShapeUtils.js';
  ...
  return _createClass(Pie, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function (entry, i) {
        ...
        }), /*#__PURE__*/React__default.createElement(Shape, _extends({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /*#__PURE__*/React__default.createElement(Curve, _extends({}, props, {
        key: key,
        type: "linear",
        className: className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /*#__PURE__*/React__default.createElement(Text, _extends({}, props, {
