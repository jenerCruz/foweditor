...
import { interpolateNumber, uniqueId, mathSign } from '../util/DataUtils.js';
import { filterProps, findAllByType } from '../util/ReactUtils.js';
import { Global } from '../util/Global.js';
import { findPositionOfBar, getBaseValueOfBar, truncateByDomain, getValueByDataKey, getCateCoordinateOfBar, getTooltipItem } from '../util/ChartUtils.js';
import { adaptEventsOfChild } from '../util/types.js';
import { BarRectangle, minPointSizeCallback } from '../util/BarUtils.js';
  ...
  return _createClass(Bar, [{
    ...
    value: function renderBackground() {
      ...
      return data.map(function (entry, i) {
        ...
        return /*#__PURE__*/React__default.createElement(BarRectangle, _extends({
