...
import { LabelList } from '../component/LabelList.js';
import { Global } from '../util/Global.js';
import { isNumber, interpolateNumber, uniqueId } from '../util/DataUtils.js';
import { getValueByDataKey, getCateCoordinateOfLine } from '../util/ChartUtils.js';
import { filterProps, hasClipDot } from '../util/ReactUtils.js';
...
var Area = /*#__PURE__*/function (_PureComponent) {
  ...
  return _createClass(Area, [{
    ...
    value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
      ...
      return /*#__PURE__*/React__default.createElement(Layer, {
      ...
      }, /*#__PURE__*/React__default.createElement(Curve, _extends({}, filterProps(others, true), {
        points: points,
      ...
      })), stroke !== 'none' && /*#__PURE__*/React__default.createElement(Curve, _extends({}, filterProps(this.props, false), {
        ...
        fill: "none",
        points: points
      })), stroke !== 'none' && isRange && /*#__PURE__*/React__default.createElement(Curve, _extends({}, filterProps(this.props, false), {
        className: "recharts-area-curve",
        layout: layout,
        type: type,
        connectNulls: connectNulls,
...
_defineProperty(Area, "renderDotItem", function (option, props) {
  ...
  if ( /*#__PURE__*/React__default.isValidElement(option)) {
    ...
    dotItem = /*#__PURE__*/React__default.createElement(Dot, _extends({}, rest, {
      key: key,
      className: className
    }));
  }
